        ...
        <main class="main">
            ...
            <div class="container-fluid">
                <div class="animated fadeIn">
                    <div class="row">
                        <div class="col-6">
                            <form class="form-horizontal" action="{{route('currencyCode.store')}}" method="post" enctype="multipart/form-data">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row cc1" >
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" value=""  type="text" name="code"  id="cc1" placeholder="Currency Code" />
                                                @if ($errors->has('code'))
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    $('#exchange').select2();
                    //$('#base_currency').select2().val(cid).trigger('change');
                }
            });
        });
