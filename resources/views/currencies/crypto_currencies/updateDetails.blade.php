        ...
        <main class="main">
            ...
            <div class="container-fluid">
                <div class="animated fadeIn">
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal" action="{{route('currencies.cryptoDetails.updateDetails')}}" method="post" >
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <input type="hidden" name="currency_id" value="{{$detail->cid}}" id="cid">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <input type="hidden" name="type" value="{{$detail->type}}" id="detail_type">
                                            </div>
                                        </div>
                                        <div class="form-group row url">
                                            <label class="col-md-3 col-form-label" for="text-input">URL</label>
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{old('else_url')?old('else_url'):$detail->url}}"  type="url" name="else_url" placeholder="Enter URL" />
                                        ...
                                        <div class="form-group row text">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control tag_text" value="{{old('tag_text')?old('tag_text'):$detail->text}}"  type="text" name="tag_text"  placeholder="Enter Tag" />
