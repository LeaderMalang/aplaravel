        ...
        <main class="main">
            ...
            <div class="container-fluid">
                <div class="animated fadeIn">
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal" action="{{route('currencies.crypto.store')}}" method="post" enctype="multipart/form-data">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{old('circulating_supply')}}"  type="number" name="circulating_supply" placeholder="Circulating Supply" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{old('max_supply')}}"  type="number" name="max_supply" placeholder="Max Supply" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{old('total_supply')}}"  type="number" name="total_supply" placeholder="Total Supply" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{old('ranking')}}"  type="text" name="ranking" placeholder="Rank 1" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <label class="switch switch-3d switch-success">
                                                    <input  name="mineable" id="mineable" type="checkbox" class="switch-input" {{old('mineable')==1?"Checked":""}} value="{{old('mineable')}}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <label class="switch switch-3d switch-success">
                                                    <input  name="status" id="status" type="checkbox" class="switch-input" {{old('status')==1?"Checked":""}} value="{{old('status')}}">
                                                    <span class="switch-label"></span>
                                                    <span class="switch-handle"></span>
                                                </label>
                                            </div>
