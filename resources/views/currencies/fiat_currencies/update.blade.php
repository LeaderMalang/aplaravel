    ...
    <!-- Main content -->
        <main class="main">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Update Fiat Currency</a></li>
            ...
            <div class="container-fluid">
                <div class="animated fadeIn">
                    <div class="row">
                        <div class="col-6">
                            <form class="form-horizontal" action="{{route('currencies.fiat.update')}}" method="post" enctype="multipart/form-data">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @csrf
                                        <input type="hidden" name="id" value="{{$fiat_currencies->id}}">
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="text-input">Name</label>
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{old('name')?old('name'):$fiat_currencies->name}}"  type="text" name="name" placeholder="Name" />
                                                @if ($errors->has('name'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{old('slug')?old('slug'):$fiat_currencies->slug}}"  type="text" name="slug" placeholder="slug" />
                                                @if ($errors->has('slug'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{old('symbol')?old('symbol'):$fiat_currencies->symbol}}"  type="text" name="symbol" placeholder="Symbol" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{old('exchange_rate')?old('exchange_rate'):$fiat_currencies->exchange_rate}}"  type="number" name="exchange_rate" placeholder="Exchange Rate" />
