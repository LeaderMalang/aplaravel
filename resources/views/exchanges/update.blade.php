    ...
    <!-- Main content -->
        <main class="main">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Update Exchange</a></li>
            ...
            <div class="container-fluid">
                <div class="animated fadeIn">
                    <div class="row">
                        <div class="col-6">
                            <form class="form-horizontal" action="{{route('exchanges.update')}}" method="post" enctype="multipart/form-data">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{$exchange->name}}"  type="text" name="name" placeholder="Name" />
                                                @if ($errors->has('name'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{$exchange->slug}}"  type="text" name="slug" placeholder="Slug" />
                                                @if ($errors->has('slug'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{$exchange->url}}"  type="url" name="url" placeholder="URL" />
                                                @if ($errors->has('url'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{$exchange->fetch_url}}"  type="url" name="fetch_url" placeholder="Fetch URL" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <label class="switch switch-3d switch-success">
                                                    <input  type="checkbox" onclick="showFee()" id="has_fee" {{($exchange->has_fee==1)?  "checked":""}}  class="switch-input" name="has_fee" value="{{$exchange->has_fee}}">
                                        ...
                                        <div class="form-group row fee">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{$exchange->fee}}"   step="any" type="number" name="fee" placeholder="Fee" />
                                                @if ($errors->has('fee'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <label class="switch switch-3d switch-success">
                                                    <input  type="checkbox" onclick="setValue()" {{($exchange->status==1)?  "checked":""}} class="switch-input" id="status" name="status" value="{{$exchange->status}}">
                                                    <span class="switch-label"></span>
                                                    <span class="switch-handle"></span>
                                                </label>
