    ...
    <!-- Main content -->
        <main class="main">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">New Permission</a></li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{old('slug')}}"  type="text" name="slug" placeholder="Permission Name" />
                                                @if ($errors->has('slug'))
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="text-input">Permission Code</label>
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{old('name')}}"  type="text" name="name" placeholder="Permission Code" />
                                                @if ($errors->has('name'))
