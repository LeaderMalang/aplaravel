    ...
    <!-- Main content -->
        <main class="main">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Update Permission</a></li>
            ...
            <div class="container-fluid">
                <div class="animated fadeIn">
                    <div class="row">
                        <div class="col-6">
                            <form class="form-horizontal" action="{{route('permission.update')}}" method="post" enctype="multipart/form-data">
                                <div class="card">

                                    <div class="card-header">

                                        <strong>Permission</strong> Details
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="text-input">Permission</label>
                                            <div class="col-md-9">
                                                <input class="form-control" value="{{$permission->name?$permission->name:old('name')}}"  type="text" name="name" placeholder="Permission" />
                                                @if ($errors->has('name'))
