    ...
    <!-- Main content -->
        <main class="main">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Assign Role To User</a></li>
            ...
            <div class="container-fluid">
                <div class="animated fadeIn">
                    <div class="row">
                        <div class="col-6">
                            <form class="form-horizontal" action="{{route('role.assignuser.store')}}" method="post" enctype="multipart/form-data">
                                <div class="card">

                                    <div class="card-header">

                                        <strong>Assign Role</strong> To User
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 col-form-label">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" id="radio1" type="checkbox" value="{{$role->name}}" name="role[]" />
                                                    <label class="form-check-label" for="radio1">{{$role->name}}</label>
                                                </div>
                                                @endforeach
                                                    @if ($errors->has('role'))
